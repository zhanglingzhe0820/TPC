...
QUERY_INTERVAL="1000000000"

DATABASE_RECORDS_COUNT="5000000"

RANDOM_UNSEQ_RANGE="3000000"
...
SUT_PARAMETERS="iotdbinfo=$DB_HOST:$DB_PORT:$CACHE_THRESHOLD:$DELAY_DISTRIBUTION:$QUERY_INTERVAL:$DATABASE_RECORDS_COUNT:$RANDOM_UNSEQ_RANGE"
